    ...
    class SoundsInstance {
        constructor(container, engine) {
                ...
                for (const event of soundsOptions.events) {
                    const cb = async (args) => {
                        ...
                        if (!this._container || this._container.muted || this._container.destroyed) {
                            (0, tsparticles_engine_1.executeOnSingleOrMultiple)(event.event, (item) => {
                        ...
                        if (event.audio) {
                            this._playBuffer((0, tsparticles_engine_1.itemFromSingleOrMultiple)(event.audio));
                        }
                        else if (event.melodies) {
                            const melody = (0, tsparticles_engine_1.itemFromArray)(event.melodies);
                            ...
                            const note = (0, tsparticles_engine_1.itemFromArray)(event.notes);
            ...
            this._playNote = async (notes, noteIdx, loop) => {
                ...
                const promises = (0, tsparticles_engine_1.executeOnSingleOrMultiple)(value, async (_, idx) => {
            ...
            this._playNoteValue = async (notes, noteIdx, valueIdx) => {
                ...
                const value = (0, tsparticles_engine_1.itemFromSingleOrMultiple)(note.value, valueIdx, true);
                try {
            ...
            this._updateVolume = () => {
                ...
                (0, tsparticles_engine_1.clamp)(this._volume, soundsOptions.volume.min, soundsOptions.volume.max);
        ...
        async init() {
            ...
            for (const event of events) {
                ...
                (0, tsparticles_engine_1.executeOnSingleOrMultiple)(event.audio, async (audio) => {
